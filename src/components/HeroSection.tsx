    ...
    <section className="relative bg-background py-4 px-4 text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        <div className="flex items-center justify-center gap-2">
          <img src="/assets/anchor_life_logo-removebg-preview-DE8-uPpR.png" alt="Anchor Life" className="h-20 w-auto object-contain" />
        </div>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-lg md:text-xl px-8 py-4 rounded-full transition-all duration-200 hover:scale-105 shadow-lg shadow-primary/30 animate-pulse-scale"
        >
