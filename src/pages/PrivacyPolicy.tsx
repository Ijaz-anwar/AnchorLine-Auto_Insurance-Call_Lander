            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                ...
                <div className="bg-card rounded-xl p-8 shadow-sm border border-border space-y-6 text-foreground">
                    ...
                    <p className="text-muted-foreground">
                        Thank you for choosing to be part of our community at AnchorLine Insurance ("Company", "we", "us", "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at <a href="tel:+19412496799" className="text-primary hover:underline">9412496799</a>.
                    </p>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">Table of Contents</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">1. What Information Do We Collect?</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">2. How Do We Use Your Information?</h2>
                        <p className="text-muted-foreground">
                            In Short: We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.
                        </p>
                        <p className="text-muted-foreground">We use the information we collect or receive:</p>
                        <ul className="list-disc list-inside text-muted-foreground ml-4">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">3. Will Your Information Be Shared With Anyone?</h2>
                        <p className="text-muted-foreground">
                            In Short: We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.
                        </p>
                        <p className="text-muted-foreground">We may process or share your data based on the following legal basis:</p>
                        <ul className="list-disc list-inside text-muted-foreground ml-4">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">4. Who Will Your Information Be Shared With?</h2>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">5. Text Messaging Consent and Data Use</h2>
                        <p className="text-muted-foreground">
                        ...
                        <p className="text-muted-foreground">
                            All categories of personal information described in this Privacy Policy exclude text messaging originator opt-in data and consent; this information will not be shared, sold, rented, or transferred to any third parties. Only AnchorLine Insurance may send text messages to individuals who have opted in.
                        </p>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">6. Do We Use Cookies and Other Tracking Technologies?</h2>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">7. Do We Use Google Maps Platform APIs?</h2>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">8. How Long Do We Keep Your Information?</h2>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">9. How Do We Keep Your Information Safe?</h2>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">10. Do We Collect Information From Minors?</h2>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">11. What Are Your Privacy Rights?</h2>
                        <p className="text-muted-foreground">
                            In Short: You may review, change, or terminate your account at any time.
                        </p>
                        <p className="text-muted-foreground">
                            If you have questions or comments about your privacy rights, you may contact us at <a href="tel:+19412496799" className="text-primary hover:underline">9412496799</a>.
                        </p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">12. Controls for Do-Not-Track Features</h2>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">13. Do California Residents Have Specific Privacy Rights?</h2>
                        <p className="text-muted-foreground">
                        ...
                        <h3 className="font-semibold mt-2">CCPA Privacy Notice</h3>
                        <p className="text-muted-foreground">Your rights with respect to your personal data:</p>
                        <ul className="list-disc list-inside text-muted-foreground ml-4">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">14. Do We Make Updates to This Notice?</h2>
                        <p className="text-muted-foreground">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-semibold text-primary">15. How Can You Contact Us About This Notice?</h2>
                        <p className="text-muted-foreground">
                            If you have questions or comments about this notice, you may contact us at <a href="tel:+19412496799" className="text-primary hover:underline">9412496799</a>, or by post to:
                        </p>
                        <address className="not-italic text-muted-foreground mt-2 border-l-4 border-primary pl-4">
                            AnchorLine Insurance<br />
                            United States
                        </address>
                    </section>

                    <div className="pt-8 border-t border-border mt-8">
                        <h3 className="font-bold text-primary mb-2">Important Legal Disclosure</h3>
                        <p className="text-xs text-muted-foreground">
                            This website is not a government agency. AnchorLine Insurance is a private lead generation service owned and operated by AnchorLine Insurance. Insurance plans referenced may not meet Affordable Care Act (ACA) requirements and may not be available in all states. By submitting your information, you provide express written consent to be contacted by AnchorLine Insurance via phone call, text message, or email, including through autodialed, AI, or prerecorded messages, even if your number is on a state or national Do Not Call registry. Message frequency may vary and message and data rates may apply. Only AnchorLine Insurance may send text messages.
                        </p>
